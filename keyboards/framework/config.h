...
// USB serial number from RP2040 flash unique ID.
// (Framework's factory-programmed serial needed core patches; upstream QMK
// provides the hardware ID mechanism instead.)
